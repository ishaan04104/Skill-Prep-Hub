...
function bindEvents(){
  ...
  $('#mobileFilters').addEventListener('click', () => $('#setupRail').classList.add('open'));
  $('#closeRail').addEventListener('click', () => $('#setupRail').classList.remove('open'));
...
function showView(view){
  ...
  if(window.innerWidth < 980) $('#setupRail').classList.remove('open');
}
